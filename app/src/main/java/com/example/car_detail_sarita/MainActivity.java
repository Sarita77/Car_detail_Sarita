package com.example.car_detail_sarita;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initItems() {
        txtMake = findViewById(R.id.etMake);
        txtYear = findViewById(R.id.etYear);
        txtColor = findViewById(R.id.etColor);
        txtPurchasePrice = findViewById(R.id.etPurchasePrice);
        txtEngineSize = findViewById(R.id.etEngineSize);
